...
public class sendOTPServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String password = (String) request.getAttribute("password_newAccount");
            String fullName = (String) request.getAttribute("fullname_newAccount");
            String phone = (String) request.getAttribute("phone_newAccount");
